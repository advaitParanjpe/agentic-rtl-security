...
`ifndef BUG_FAILED_AUTH_DOES_NOT_CLEAR_SESSION
  `define BUG_FAILED_AUTH_DOES_NOT_CLEAR_SESSION 0
`endif

`ifndef BUG_BOOT_LOCK_SESSION_PERSIST
  `define BUG_BOOT_LOCK_SESSION_PERSIST 0
`endif

`ifndef BUG_CHAL_ROTATE_DOES_NOT_CLEAR_SESSION
  `define BUG_CHAL_ROTATE_DOES_NOT_CLEAR_SESSION 0
`endif

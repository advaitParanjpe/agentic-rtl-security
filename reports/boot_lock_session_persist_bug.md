...
- Timestamp: `2026-05-05T21:26:56`
- Trace: `/Users/advaitparanjpe/Desktop/agentic-rtl-security/traces/policy_boot_lock_session_persist.json`
- Active bug defines: `BUG_BOOT_LOCK_SESSION_PERSIST`
...
[TRACE 4] SECURE sets BOOT_LOCK, which should clear active session
[PASS] WRITE addr=0x08 data=0x00000001 priv=SECURE error=0

[TRACE 5] USER confirms session was cleared by BOOT_LOCK
[FAIL] READ addr=0x28 priv=  USER expected rdata=0x00000000 error=0, got rdata=0x00000001 error=0

[TRACE 6] USER should no longer read PROTECTED_DATA after BOOT_LOCK clears session
[FAIL] READ addr=0x2c priv=  USER expected rdata=0x00000000 error=1, got rdata=0xbeef1234 error=0
...
========================================
RESULT: FAIL
/Users/advaitparanjpe/Desktop/agentic-rtl-security/tb/tb_mini_soc.sv:279: $finish called at 260000 (1ps)
